		...
		*/
		...
		public function Copyright(){
			return '<div class="copyright">
						'.((!defined('TMP_DISABLE_EQDKP_URL')) ? '<a href="'.EQDKP_ABOUT_URL.'" target="new">' : '').'Powered by <b>EQdkp Plus</b> '.((DEBUG > 3) ? '[FILE: '.VERSION_INT.'/'.$this->config->get('plus_version').', DB: '.$this->config->get('update_core', 'maintenance_tasks').']' : '').' &copy; '.$this->time->date('Y', $this->time->time).' EQdkp Plus Team'.((!defined('TMP_DISABLE_EQDKP_URL')) ? '</a>' : '').'
