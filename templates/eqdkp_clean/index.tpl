...
<html lang="{L_XML_LANG}">
	<head>
		...
		<meta name="theme-color" content="{T_MENU_BACKGROUND_COLOR}">
		<!-- IF S_REPONSIVE -->
				...
				<nav id="nav" itemscope itemtype="http://schema.org/SiteNavigationElement">
					<div id="mainmenu">
						...
						<div class="hiddenDesktop nav-mobile">
							<div class="mobileMainLogo"><a href="{EQDKP_CONTROLLER_PATH}{SID}">{MAIN_TITLE}</a></div>
							<i class="fa fa-list hand" onclick="$('.nav-mobile .mobile-overlay').toggle();"></i>
							<!-- IF S_LOGGED_IN -->
								<span class="hand user-avatar user-avatar-border user-avatar-smallest floatRight" onclick="$('.nav-mobile .mobile-overlay-user').toggle();"><img src="{USER_AVATAR}" alt="{USER_NAME}"/></span>
							<!-- ELSE -->
							...
							<div class="mobile-overlay-user">
								...
								<div class="overlay-content">
									<nav class="usermenu-mobile-wrapper"><div class="heading">{L_user}</div>
										<ul class="usermenu-mobile">
											<!-- IF S_LOGGED_IN -->
												<li><a href="{EQDKP_CONTROLLER_PATH}Settings{SEO_EXTENSION}{SID}"><i class="fa fa-cog fa-lg"></i> {L_settings}</a></li>
												<li><a href="{U_LOGOUT}"><i class="fa fa-sign-out fa-lg"></i> {L_logout}</a></li>
												<li><a href="{U_USER_PROFILE}"><i class="fa fa-g fa-user"></i> {L_my_profile}</a></li>
												<!-- BEGIN user_tooltip_addition -->
												<li class="{user_tooltip_addition.CLASS}">{user_tooltip_addition.TEXT}</li>
												<!-- END user_tooltip_addition -->
												<!-- IF USER_IS_AWAY -->
												...
												<!-- IF U_CHARACTERS != "" --><li><a href="{U_CHARACTERS}" class="sub-menu-arrow"><i class="fa fa-group fa-lg"></i> <span>{L_menu_members}</span></a>
												<!-- IF S_MYCHARS_POINTS and U_CHARACTERS != "" -->
													<ul class="sub-menu">
													<!-- BEGIN mychars_points -->
													<li><a href="{mychars_points.CHARLINK}"><span class="icons">{mychars_points.CHARICON}</span> {mychars_points.CHARNAME} - {mychars_points.POOLNAME}: {mychars_points.CURRENT}</a></li>
													<!-- END mychars_points -->
													</ul>
												<!-- ENDIF -->
												...
												<li><a href="{EQDKP_CONTROLLER_PATH}Notifications{SEO_EXTENSION}{SID}"><i class="fa fa-bell fa-lg"></i> {L_notifications}
													<span class="bubble-red notification-bubble-red" <!-- IF NOTIFICATION_COUNT_RED == 0 -->style="display:none;"<!-- ENDIF --> >{NOTIFICATION_COUNT_RED}</span>
													<span class="bubble-yellow notification-bubble-yellow" <!-- IF NOTIFICATION_COUNT_YELLOW == 0 -->style="display:none;"<!-- ENDIF -->>{NOTIFICATION_COUNT_YELLOW}</span>
													<span class="bubble-green notification-bubble-green" <!-- IF NOTIFICATION_COUNT_GREEN == 0 -->style="display:none;"<!-- ENDIF -->>{NOTIFICATION_COUNT_GREEN}</span>
												</a></li>
											<!-- ELSE -->
											<li><a href="{EQDKP_CONTROLLER_PATH}Login{SEO_EXTENSION}{SID}"><i class="fa fa-sign-in fa-lg"></i> <span>{L_login}</span></a></li>
											<!-- IF U_REGISTER != "" --><li>{U_REGISTER}</li><!-- ENDIF -->
											<!-- ENDIF -->
											
											<!-- IF S_SEARCH -->
											<li><a href="{EQDKP_CONTROLLER_PATH}Search{SEO_EXTENSION}{SID}"><i class="fa fa-search"></i> {L_search}</a></li>
											<!-- ENDIF -->
