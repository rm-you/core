		...
		*/
		...
		private function copy_config($config) {
			...
			$needed_configs = array(
				...
				'game_importer_clientid'		=> 'game_importer_clientid',
				'game_importer_clientsecret'	=> 'game_importer_clientsecret',
			);
		...
		public function get_precache_progress_file(){
			return $this->pfh->FilePath('itt_precache_offset.txt', 'eqdkp');
		}
